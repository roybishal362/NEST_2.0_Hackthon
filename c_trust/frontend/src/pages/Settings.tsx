    ...
    return (
        <div className="space-y-8 max-w-3xl">
            <header>
                ...
                <p className="text-slate-500 dark:text-slate-400 mt-2">Manage your preferences and system configuration.</p>
            </header>
            ...
            <section className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <div className="text-sm text-slate-500 dark:text-slate-400">Toggle dark theme for the dashboard</div>
                    </div>
                    <button
                    ...
                    {[
                        ...
                        <div key={item.key} className="flex items-center justify-between py-2">
                            ...
                            <button
                                ...
                                className={`relative w-14 h-8 rounded-full transition-colors ${
                                    notifications[item.key as keyof typeof notifications] ? 'bg-indigo-600' : 'bg-slate-200 dark:bg-slate-600'
                                }`}
                            >
                                <span
                                    className={`absolute top-1 w-6 h-6 bg-white rounded-full shadow transition-transform ${
            ...
            {/* DQI Configuration */}
            <section className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700">
                <h2 className="text-lg font-semibold text-slate-900 dark:text-white mb-4">DQI Configuration</h2>
                ...
                <div className="space-y-3">
                    {[
                        ...
                        <div key={dim.name} className="flex items-center gap-4">
                            <div className="w-32 text-sm font-medium text-slate-700 dark:text-slate-300">{dim.name}</div>
                            ...
                            <div className="w-12 text-right text-sm font-semibold text-slate-900 dark:text-white">{dim.weight}%</div>
                        </div>
                    ))}
                </div>
            </section>
            ...
            <section className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                        ...
                        <div className="font-medium text-slate-900 dark:text-white">C-TRUST v1.0.0</div>
                    </div>
                    <div>
                        <div className="text-slate-500 dark:text-slate-400">Environment</div>
                        <div className="font-medium text-slate-900 dark:text-white">Development</div>
                    </div>
                    <div>
                        <div className="text-slate-500 dark:text-slate-400">API Status</div>
                        <div className="font-medium text-green-600">Connected</div>
                    </div>
                    <div>
                        <div className="text-slate-500 dark:text-slate-400">Last Data Refresh</div>
                        <div className="font-medium text-slate-900 dark:text-white">2 hours ago</div>
                    </div>
                </div>
            </section>
        </div>
